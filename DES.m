...
% Define subsitution function (SBOX)
...
% Define key shift function (KS)
KS = @(key28,s) [key28(s+1:end),key28(1:s)];    
% Define sub-keys for each round
